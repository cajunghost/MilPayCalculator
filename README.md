...
- TSP projection using the Plan tab profile, member TSP contribution, 5% match, starting balance, monthly compounding from annual return, and USAF average time-in-grade promotion timing
